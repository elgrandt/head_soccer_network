...
def main():
    ...
    pygame.display.set_caption("Head soccer 05")
    graphicManager = GraphicManager() #instanciate the graphic manager
    graphicManager.SetScreen(screen) #telling graphic manager where to paint the game (in our screen)
